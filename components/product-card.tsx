...
export default function ProductCard({ image, title, description, price, code, delay = 0 }: ProductCardProps) {
        ...
        <>
            ...
            >
                ...
                <CardContent className="p-6">
                    ...
                    {/* Display product code with styling */}
                    <p className="text-sm text-gray-500 mt-2 italic">
                        <span className="font-semibold text-purple-700">Cod produs:</span> {code || "N/A"}
                    </p>
                </CardContent>
                <CardFooter className="p-6 pt-0">
                    <Button
                        className="w-full bg-purple-700 hover:bg-purple-800 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5"
            ...
            {isModalOpen && (
                ...
                >
                    <img
                        src={image}
                        alt={title}
                        className="max-w-4xl max-h-[80vh] rounded-lg shadow-lg transition-transform duration-300"
                    />
                </div>
            )}
        </>
